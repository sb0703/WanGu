...
const Map<String, Item> containerItems = {
  ...
  'void_box': Item(
    ...
    slot: EquipmentSlot.back,
    levelReq: 55,
    spaceBonus: 100, // ∞ (Simulated as 100)
    price: 50000,
  ),
  'mountain_river_box': Item(
    id: 'mountain_river_box',
    name: '山河盒·地脉系',
    description: '可暂存灵脉精华与矿脉样本。',
    type: ItemType.storage,
    slot: EquipmentSlot.back,
    levelReq: 57,
    spaceBonus: 50, // XL
  ...
  'life_box_pendant': Item(
    id: 'life_box_pendant',
    name: '佩饰·命匣',
    description: '濒死时自动封存随身贵重物。',
    type: ItemType.storage,
    slot: EquipmentSlot.accessory,
    levelReq: 59,
    spaceBonus: 10, // M
